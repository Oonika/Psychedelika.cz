...
to add more sites go to:
https://developers.facebook.com/apps/326849018289259/dashboard/
my apps > settings > advanced > add domain > add url of all domains where you have fb comenting

better to use app id as admin it is trackable and viewable in code
